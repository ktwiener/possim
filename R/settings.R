...
settings <- tibble::tribble(
  ...
  "Full exchangeability",    10, 6000, 0.4,      -2, log(1),   0.5,    0.5,
  "Partial exchangeability", 10, 6000, 0.4,      -2, log(1),     1,    0.5,
  "Full exchangeability",    10, 6000, 0.4,      -2, log(0.8), 0.5,    0.5,
  "Partial exchangeability", 10, 6000, 0.4,      -2, log(0.8),   1,    0.5
)
